...
#   - The default nearest neighbor matching method in MatchIt is “greedy�? matching, where the closest control match for each treated unit is chosen
...
#         and (c) the percent improvement in balance for each of the balance measures, defined as 100((|a|−|b|)/|a|),
