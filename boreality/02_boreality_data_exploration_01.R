...
# -->
# There are some zero records in several variables (Oxalis, boreal, nBor) 



# ----------
psych::describe(Boreality)


Hmisc::describe(Boreality)



# -->
# but "Oxalis" have only 2 distinct values
