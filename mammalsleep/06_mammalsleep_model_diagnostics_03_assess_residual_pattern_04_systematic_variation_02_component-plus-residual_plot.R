...
car::crPlots(mod_obj, ~ log(body), smooth = list(span = 0.5), id = TRUE)
car::ceresPlots(mod_obj, ~ log(body), smooth = list(span = 0.5), id = TRUE)


car::crPlots(mod_obj, ~ log(lifespan), smooth = list(span = 0.5), id = TRUE)
car::ceresPlots(mod_obj, ~ log(lifespan), smooth = list(span = 0.5), id = TRUE)


car::crPlots(mod_obj, ~ danger, smooth = list(span = 0.5), id = TRUE)
car::ceresPlots(mod_obj, ~ danger, smooth = list(span = 0.5), id = TRUE)
...
car::crPlots(mod_obj2b, ~ poly(log(body),3), smooth = list(span = 0.5), id = TRUE)
