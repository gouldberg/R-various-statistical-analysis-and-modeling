...
# -->
# The results show that the significant variables are the presence of reported hay fever and gender.
# The coefficient of the second pollution source is marginally significant.
# The smoothed residual term using splines is significant,
# which suggests that ther may have been some residual spatial variation unexplained in the generalized linear model.
