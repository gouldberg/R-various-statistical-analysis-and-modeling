...
centiles(m0, dbbmi1$age, cent = c(5, 25, 50, 75, 95))

calibration(m0, xvar = dbbmi1$age, cent = c(5, 25, 50, 75, 95))
...
centiles.fan(m0, dbbmi1$age, cent = c(5, 25, 50, 75, 95), ylab = "bmi", xlab = "age", colors = "gray")
