...
ercomp(c.eq, crime4.p)



# -->
# Here for the error, the share of the individual effect and that of the idiosyncratic effect are 82.4% and 17.6%

# theta = 0.8281:  GLS estimator removes about only 82.81% of the individual mean
