...
m_mod1 <- matchit(formula = nj ~ bk + kfc + roys + wendys + co_owned, data = njmin3_2, method = "genetic", replace = FALSE)
m_mod2 <- matchit(formula = nj ~ bk + kfc + roys + wendys + co_owned, data = njmin3_2, method = "genetic", replace = TRUE)
m_mod3 <- matchit(formula = nj ~ rest_type + co_owned, data = njmin3_2, method = "genetic", replace = FALSE)
m_mod4 <- matchit(formula = nj ~ rest_type + co_owned, data = njmin3_2, method = "genetic", replace = TRUE)
...
# -->
# method = "genetic" and replace = TRUE or FALSE:  propensity scores is NOT predictive
