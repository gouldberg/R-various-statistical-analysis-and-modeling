...
# Supplementary variables with quantitative variable (11 and 12:  number of points and rank)

graphics.off()
par(mfrow=c(1,2))

res.pca1 <- FactoMineR::PCA(decathlon[,1:12], quanti.sup = 11:12)



# -->
# quantitative variables (11 and 12) are added in variables factor map
...
res.pca2 <- FactoMineR::PCA(decathlon, quanti.sup = 11:12, quali.sup = 13)
...
# -->
# qualitative variables (13) are added in individuals factor map
