...
idx <- which(rownames(mammalsleep) %in% rownames(res))

cbind(mammalsleep[idx, c("body", "lifespan", "danger")], res)



# -->
# None of the cases are particulary influential on the model coefficients overall: the largest Cook's D is only 0.16 for case Asian.elephant.
