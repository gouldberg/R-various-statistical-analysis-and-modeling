...
# -->
# We presume that there will be some interactions, but sampling design is such that we can eliminate the majority of them.
# Length and weight of hake will almost certainly be highly collinear, hence we need to use only one of them.
