...
# ------------------------------------------------------------------------------
# Diagnosing discrete distributions:  Ord plots  (manual calculation)
...
# -->
# The weighted least squares line, with weights, has a slope (-0.03) close to zero, indicating the Poisson distribution.
# The estimated lambda = a = 0.656 compares favarable with the maximum likelihood estimate (MLE), lambda = 0.610,
# and the value from the Poissonness plot.
