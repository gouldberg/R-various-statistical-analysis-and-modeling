...
# ------------------------------------------------------------------------------
# Plot standardized residuals versus spatial coordinates
# ------------------------------------------------------------------------------
...
# -->
# There seems to be some spatial pattern as most of the positive residulas as well as the negative residuals are showing some clustering.
