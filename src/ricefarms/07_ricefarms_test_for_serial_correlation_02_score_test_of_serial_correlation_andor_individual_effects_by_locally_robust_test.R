...
# -->
# The robust tests allow us to discriminate between time-invariant error persistence (random effects) and
# time-decaying persistence (autoregressive errors),
# concluding in favor of the time-decaying persistence
