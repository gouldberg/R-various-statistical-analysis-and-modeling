...
myinits <- list(list(alphamu=.5, alphalambda=1, betamu=.5, betalambda=1, alpha=rep(.5, ns), beta=rep(.1, ns)))



# ------------------------------------------------------------------------------
# model:  structured individual differences
# ------------------------------------------------------------------------------
#### Notes to Stan model #######################################################
## 1) Same problem as in previous model Retention_2, but here it infulences also 
