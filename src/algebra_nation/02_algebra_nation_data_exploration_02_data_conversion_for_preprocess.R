...
# number of logins is the sum of teacher and student logins for a school from all sources
# (classroom, lab, and home computers, smartphones, and tablets),
# and number of examinees is the number of students in the school wo took the Algebra I EOC assessment in the spring of 2014
