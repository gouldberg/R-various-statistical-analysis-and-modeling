...
idx <- which(rownames(PhdPubs) %in% rownames(res))

cbind(PhdPubs[idx, c("articles", "married", "female", "kid5", "mentor", "phdprestige")], res)



# -->
# None of the cases are particulary influential on the model coefficients overall: the largest Cook's D is only 0.37 for case 328.
