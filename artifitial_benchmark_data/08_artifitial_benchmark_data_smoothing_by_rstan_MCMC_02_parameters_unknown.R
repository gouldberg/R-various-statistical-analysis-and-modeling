...
# Bulk effective samples sie (ESS) is too low, indicating posterior means and medians may be unreliable.

# W = 0.33 and V = 30.41, very different
...
# -->
# W (system noise) is not sampled properly ...
...
# ----------
stan_mcmc_out2 <- rstan::extract(fit_stan, pars = "W")

hist(stan_mcmc_out2$W)
