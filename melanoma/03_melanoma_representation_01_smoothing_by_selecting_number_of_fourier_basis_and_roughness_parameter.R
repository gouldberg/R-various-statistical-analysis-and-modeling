...
# ------------------------------------------------------------------------------
# Choose best # of fourier basis and roughness parameter
# ------------------------------------------------------------------------------
...
# # of basis = 9 and lambda = 10 ^ 0.5 is smallest gcv
...
plot(t36.72, melanoma$incidence, xlab='Year', ylab = '# of melanoma cases per 100,000', las=1)
