...
# -->
# BEW is logit link for mu and sigma both.


# ----------
# There are zero values, so add very small value
gamlss(data$ratio + 0.0000001 ~ 1, family = BE)



# ----------
m1 <- histDist(data$ratio + 0.0000001, family = BE)


m1


faraway::ilogit(-5.147)

faraway::ilogit(-1.593)
